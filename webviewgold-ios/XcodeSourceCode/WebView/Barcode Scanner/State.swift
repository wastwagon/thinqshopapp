...
public struct StateMessageProvider {
  public var scanningText = localizedString("Place the barcode within the window to scan. The search will start automatically.")
  public var processingText = localizedString("Looking for your product...")
  public var unathorizedText = localizedString("In order to scan barcodes you have to allow camera under your settings.")
  public var notFoundText = localizedString("No product found.")
