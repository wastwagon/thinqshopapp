...
export async function seedWorldClassContent(prisma: PrismaClient) {
    ...
    const settings = [
        ...
        { setting_key: 'support_phone', setting_value: '+233 XX XXX XXXX', description: 'Support phone' },
        { setting_key: 'support_email', setting_value: 'support@thinqshop.com', description: 'Support email' },
    ];
