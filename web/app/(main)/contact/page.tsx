            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                        ...
                        <a href={`tel:${SUPPORT_PHONE_RAW}`} className="text-blue-600 font-medium text-sm hover:text-blue-700 mt-2 inline-block">+86 183 2070 9024</a>
                        <span className="block mt-1">
                            <a href={`https://wa.me/${SUPPORT_PHONE_RAW.replace(/\+/g, '')}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 font-medium text-sm hover:text-blue-700">Chat on WhatsApp →</a>
                        </span>
                    </div>
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                        <div className="w-12 h-12 rounded-xl bg-white border border-gray-200 flex items-center justify-center mb-4">
                    ...
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                        ...
                        <Link href="/dashboard" className="text-blue-600 font-medium text-sm hover:text-blue-700 mt-2 inline-block">Open Dashboard →</Link>
                    </div>
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                        <div className="w-12 h-12 rounded-xl bg-white border border-gray-200 flex items-center justify-center mb-4">
                        ...
                        <Link href="/track" className="text-blue-600 font-medium text-sm hover:text-blue-700 mt-2 inline-block">Track & support →</Link>
                    </div>
                </div>
