        ...
        <ShopLayout>
            <div className="bg-white min-h-full pb-8">
                <ShopPageShell wide className="py-8 sm:py-12">
                    ...
                    <div className="flat-card border-l-4 border-l-blue-600 p-6 sm:p-8 max-w-none text-gray-600 space-y-8 mt-6">
                        ...
                        <section>
                            ...
                            <p className="leading-relaxed">
                                ...
                                <Link href="/dashboard/wallet" className="text-blue-600 font-semibold hover:underline">wallet dashboard</Link>{' '}
