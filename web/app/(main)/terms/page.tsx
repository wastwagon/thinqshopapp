        ...
        <ShopLayout>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                ...
                <div className="flat-card p-6 sm:p-8 max-w-none text-gray-600 space-y-8">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-gray-900 mb-3">2. Use of Services</h2>
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-gray-900 mb-3">3. Shopping &amp; Orders</h2>
                        <p className="leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-gray-900 mb-3">5. Logistics, Transfers &amp; Procurement</h2>
                        <p className="leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-gray-900 mb-3">7. Changes</h2>
                        <p className="leading-relaxed mb-3">
                    ...
                    <section>
                        ...
                        <p className="leading-relaxed">
                            For questions about these terms or warranty, contact us via <Link href="/contact" className="text-brand hover:text-brand/90 font-medium">Contact Support</Link>.
                        </p>
                    </section>
