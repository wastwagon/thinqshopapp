            ...
            <div className="max-w-3xl">
                ...
                <div>
                    <div className="dashboard-table-wrap">
                        ...
                        <div className="p-6 space-y-6 md:max-h-[calc(100vh-14rem)] md:overflow-y-auto overscroll-y-contain scrollbar-thin">
                                    ...
                                    <div className="flex gap-2">
                                        {(['air_freight', 'sea_freight'] as const).map((m) => (
                                            <button
                                                ...
                                                className={`flex-1 py-3 px-4 rounded-xl text-xs font-bold  border-2 transition-all ${serviceType === m ? 'border-blue-600 bg-blue-50 text-blue-600' : 'border-gray-100 text-gray-600 hover:border-gray-200'}`}
                                            >
                ...
                <div className="space-y-3">
                    ...
                    <div className="dashboard-table-wrap">
                        ...
                        {historyLoading ? (
                            ...
                            <ul className="divide-y divide-gray-50 max-h-[70vh] overflow-y-auto overscroll-y-contain scrollbar-thin">
