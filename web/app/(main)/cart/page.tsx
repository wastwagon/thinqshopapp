                    ...
                    <ul role="list" className="divide-y divide-gray-100">
                        {cart.length === 0 && (
                            <li className="py-16 text-center px-4">
                                ...
                                <Link
                                    href="/shop"
                                    className="inline-flex mt-5 min-h-[44px] px-6 items-center justify-center rounded-xl bg-brand text-white text-sm font-semibold hover:bg-brand/90 transition-colors"
                                >
                                    Shop now
                                </Link>
                            </li>
                    ...
                    <div className="mt-5 flat-card p-5">
                        ...
                        <div className="flex flex-col gap-2.5">
                            <button
                                ...
                                className="w-full min-h-[44px] bg-brand text-white h-12 rounded-xl font-semibold text-sm hover:bg-brand/90 transition-colors disabled:opacity-40 flex items-center justify-center"
                            >
                                Checkout
                            </button>
                            <Link
