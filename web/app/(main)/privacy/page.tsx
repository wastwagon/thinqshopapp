    ...
    return (
        <ShopLayout>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                ...
                <div className="flat-card p-6 sm:p-8 max-w-none text-gray-600 space-y-8">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-gray-900 mb-3">3. Sharing of Information</h2>
                        <p className="leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-gray-900 mb-3">4. Data Retention &amp; Security</h2>
                        <p className="leading-relaxed mb-3">
                    ...
                    <section>
                        ...
                        <p className="leading-relaxed mb-3">
                            Depending on your location, you may have rights to access, correct, delete, or restrict processing of your personal data, or to object to certain processing and to data portability. You may also withdraw consent where we rely on it. To exercise these rights or ask questions, contact us via <Link href="/contact" className="text-brand hover:text-brand/90 font-medium">Contact Support</Link>. You may also have the right to lodge a complaint with a supervisory authority.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-base font-semibold text-gray-900 mb-3">6. Cookies &amp; Similar Technologies</h2>
                        <p className="leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-base font-semibold text-gray-900 mb-3">8. Contact Us</h2>
                        <p className="leading-relaxed">
                            For privacy-related questions or requests, please use our <Link href="/contact" className="text-brand hover:text-brand/90 font-medium">Contact Support</Link> page.
                        </p>
                    </section>
