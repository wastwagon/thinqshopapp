                    ...
                    <div className="bg-white/95 backdrop-blur-xl rounded-[2.5rem] p-10 md:p-14 border border-white/20 shadow-2xl shadow-black/20">
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            className="absolute right-1 top-1/2 -translate-y-1/2 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors"
                            ...
                            <button
                                ...
                                className="w-full min-h-[44px] bg-gradient-to-r from-slate-900 to-slate-800 text-white h-12 rounded-xl font-medium text-sm hover:from-brand hover:to-brand/95 transition-all disabled:opacity-50 flex items-center justify-center gap-2 mt-6 shadow-lg shadow-slate-900/20"
                            >
