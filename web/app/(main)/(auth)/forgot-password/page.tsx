                ...
                <div className="min-h-[90vh] flex items-center justify-center px-4 py-20 relative bg-[#fdfdfd] overflow-hidden">
                    ...
                    >
                        <div className="bg-white rounded-[2.5rem] p-10 md:p-14 border border-gray-100 shadow-xl shadow-gray-100/50 text-center">
                            ...
                            <h1 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 tracking-tight mb-3">Check your email</h1>
                ...
                >
                    <div className="bg-white rounded-[2.5rem] p-10 md:p-14 border border-gray-100 shadow-xl shadow-gray-100/50">
                        <div className="mb-12 text-center">
                            <h1 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 tracking-tight mb-3">Forgot password?</h1>
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <button
                                ...
                                className="w-full min-h-[44px] bg-gradient-to-r from-slate-900 to-slate-800 text-white h-12 rounded-xl font-medium text-sm hover:from-brand hover:to-brand/95 transition-all disabled:opacity-50 flex items-center justify-center gap-2 mt-8 shadow-md"
                            >
