            ...
            <div className="pb-6 md:pb-8 max-w-4xl mx-auto">
                <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <span className={`px-3 py-1 rounded-lg text-xs font-semibold border ${invoice.status === 'draft' ? 'bg-gray-100 text-gray-700 border-gray-200' : invoice.status === 'paid' ? 'bg-green-50 text-green-700 border-green-200' : 'bg-blue-50 text-blue-600 border-blue-300'}`}>
                ...
                {editing && form ? (
                    <form onSubmit={handleUpdate} className="space-y-6">
                        ...
                        <div className="flex gap-3">
                            <button type="submit" disabled={submitting} className="min-h-[44px] px-6 bg-blue-600 text-white rounded-lg font-semibold text-sm hover:bg-blue-700 disabled:opacity-50">
