                                                    ...
                                                    {(shipment.declaration_image_urls as string[]).map((url, i) => {
                                                        ...
                                                        return (
                                                            <a key={i} href={fullUrl} target="_blank" rel="noopener noreferrer" className="block">
                                                                <img src={fullUrl} alt="" className="w-24 h-24 object-cover rounded-lg border border-gray-200 hover:border-blue-300" />
                                                            </a>
                                                        );
                                                    })}
                                                </div>
                                ...
                                <div className="admin-table-wrap">
                                    ...
                                    <div className="px-4 py-4 flex items-center gap-3 flex-wrap">
                                        {shipment.origin_warehouse && (
                                            <span className="px-2.5 py-1.5 bg-blue-50 text-blue-600 rounded-lg border border-blue-200 text-sm font-medium">
