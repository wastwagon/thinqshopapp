        ...
        <DashboardLayout isAdmin={true}>
            ...
            <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="flex items-center gap-3">
                    <FolderTree className="h-7 w-7 text-brand" />
                    <div>
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="h-9 px-4 bg-brand text-white rounded-lg font-semibold text-sm hover:bg-brand/90 transition-all flex items-center gap-1.5 shrink-0"
                    >
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setIsModalOpen(false)}>
                    <div className="bg-white rounded-xl border border-gray-100 shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto overscroll-y-contain scrollbar-thin p-5" onClick={(e) => e.stopPropagation()}>
