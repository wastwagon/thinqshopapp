...
const FALLBACK_BADGES: Badge[] = [
    ...
    { id: 2, icon: 'truck', label: 'Global shipping 7–14 days', optional_link: '/terms' },
...
export default function TrustStrip({ badges }: { badges: Badge[] }) {
    ...
    return (
        <section className="bg-white border-b border-gray-200/80 py-4 sm:py-5" aria-label="Trust badges">
