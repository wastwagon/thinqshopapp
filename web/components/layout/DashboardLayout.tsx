    ...
    return (
        <div className="flex h-screen bg-gray-50 overflow-hidden font-sans text-gray-900 relative">
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative safe-area-inset-top">
                ...
                <main id="main-content" className="flex-1 overflow-y-auto overflow-x-hidden p-3 md:p-6 pb-[calc(5.5rem+env(safe-area-inset-bottom,0px))] md:pb-6 relative z-10 safe-area-inset-bottom min-w-0" tabIndex={-1} role="main">
